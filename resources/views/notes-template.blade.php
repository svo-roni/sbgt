...
<html lang="{{ config('app.locale') }}">
    <head>
		...
		-->
		<link href="{!! asset('css/notes/font-awesome.min.css') !!}" media="all" rel="stylesheet" type="text/css" />
		
		<link href="{!! asset('css/notes/owl.carousel.css') !!}" media="all" rel="stylesheet" type="text/css" />
		<link href="{!! asset('css/notes/animate.css') !!}" media="all" rel="stylesheet" type="text/css" />
		<link href="{!! asset('css/notes/main.css?id=3') !!}" media="all" rel="stylesheet" type="text/css" />
		<link href="{!! asset('css/notes/responsive.css') !!}" media="all" rel="stylesheet" type="text/css" />
    ...
    <body id="body">
        ...
        <!-- Js -->
        <script src="{!! asset('js/notes/vendor/modernizr-2.6.2.min.js') !!}"></script> 

        <script src="{!! asset('js/notes/vendor/jquery-1.10.2.min.js') !!}"></script>
        
        
        <script src="{!! asset('js/notes/jquery.lwtCountdown-1.0.js') !!}"></script>
        <!-- <script src="{!! asset('js/app.js') !!}"></script> -->
        <script src="{!! asset('js/notes/owl.carousel.min.js') !!}"></script>
        <script src="{!! asset('js/notes/jquery.validate.min.js') !!}"></script>
        <script src="{!! asset('js/notes/jquery.form.js') !!}"></script>
        <script src="{!! asset('js/notes/jquery.nav.js') !!}"></script>
        <script src="{!! asset('js/notes/jquery.sticky.js') !!}"></script>
        <script src="{!! asset('js/notes/plugins.js') !!}"></script>
        <script src="{!! asset('js/notes/wow.min.js') !!}"></script>
        <script src="{!! asset('js/notes/main.js?id=2') !!}"></script>
